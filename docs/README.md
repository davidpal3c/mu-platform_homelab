...
| [system-blueprint.md](system-blueprint.md) | Homelab **as-built** architecture (storage, node **aluna-node-01**) |
| [platform-overview.md](platform-overview.md) | Storage / boot summary |
| [engineering-log.md](engineering-log.md) | Chronological significant changes |

Build reports and reviews live under [build-reports/](build-reports/).
