...
| Resource | Path |
|----------|------|
| **Platform ontology** (Access, Context, Mira, Terra — naming and layers) | [platform-ontology.md](platform-ontology.md) |
...
| Aluna Access | Control layer | *TBD — manifests / runbooks in repo when added* |
...
- **Aluna Access / Context / Mira / Terra** — products (this folder describes all four; **Context** has its own subtree above).  
