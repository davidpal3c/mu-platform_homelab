...
|----------------|---------|----------------------------------|------------------------|
| Control | Aluna Access | Identity, policy, quota, monetization enforcement | API runtime, Postgres, Redis, control API |
...
1. **Aluna Access** is the first enforceable runtime boundary.  
