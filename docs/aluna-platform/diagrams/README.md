# Aluna platform — high-level diagrams

Mermaid sources for ontology, layering, request lifecycle, evolution, and runtime architecture. Render in GitHub, VS Code (Mermaid preview), or export via `mmdc` / documentation tooling.
...
| [07-minimal-mvp-architecture.md](07-minimal-mvp-architecture.md) | Minimal MVP flow with future Context / Mira / Terra |

**Canonical narrative:** [../platform-ontology.md](../platform-ontology.md)

**Aluna Context workload** (runtime / Celery / k3s — kept under the Context product folder): [../../aluna-context/architecture-diagrams/architecture%20diagrams.md](../../aluna-context/architecture-diagrams/architecture%20diagrams.md)
